...
namespace PortfolioEndpoint.Migrations
{
    ...
    [Migration("20200615143808_InitialDatabaseSetup")]
            ...
            modelBuilder.Entity("PortfolioEndpoint.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            FirstName = "Carson",
                            LastContact = new DateTime(2020, 6, 15, 15, 38, 8, 213, DateTimeKind.Local).AddTicks(849),
                            LastName = "Alexander",
                            TelegramId = 0
                        },
                        new
                        {
                            Id = 2,
                            FirstName = "Meredith",
                            LastContact = new DateTime(2020, 6, 15, 15, 38, 8, 216, DateTimeKind.Local).AddTicks(9186),
                            LastName = "Alonso",
                            TelegramId = 0
                        },
                        new
                        {
                            Id = 3,
                            FirstName = "Arturo",
                            LastContact = new DateTime(2020, 6, 15, 15, 38, 8, 216, DateTimeKind.Local).AddTicks(9258),
                            LastName = "Anand",
                            TelegramId = 0
                        });
                });
