...
namespace PortfolioEndpoint.Migrations
{
    ...
    [Migration("20200618140809_removingOutdatedFields")]
    partial class removingOutdatedFields
    {
            ...
            modelBuilder.Entity("PortfolioEndpoint.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExternalId = 0,
                            FirstName = "Carson",
                            LastContact = new DateTime(2020, 6, 18, 15, 8, 8, 210, DateTimeKind.Local).AddTicks(3452)
                        },
                        new
                        {
                            UserId = 2,
                            ExternalId = 0,
                            FirstName = "Meredith",
                            LastContact = new DateTime(2020, 6, 18, 15, 8, 8, 217, DateTimeKind.Local).AddTicks(2532)
                        },
                        new
                        {
                            UserId = 3,
                            ExternalId = 0,
                            FirstName = "Arturo",
                            LastContact = new DateTime(2020, 6, 18, 15, 8, 8, 217, DateTimeKind.Local).AddTicks(2676)
                        });
                });
